...
def build(*args):  # pylint: disable=too-many-branches,too-many-statements
    ...
    elif not build_modes:
        build_modes = list(utils.get_fuzzer_config_value('build', 'build_modes', default=[]))
    ...
    os.environ['AFL_QUIET'] = str(utils.get_fuzzer_config_value('build', 'quiet', default=1))
    os.environ['AFL_MAP_SIZE'] = str(utils.get_fuzzer_config_value('build', 'map_size', default=2621440))
